...
# Automatically update your CloudFlare DNS record to the IP, Dynamc DNS
...
RESPONSE=$(curl -s -X PUT "https://api.cloudflare.com/client/v4/zones/$CFZONE_ID/dns_records/$CFRECORD_ID" \
  -H "X-Auth-Email: $CFUSER" \#!/usr/bin/env bash
set -o errexit
set -o nounset
set -o pipefail
...
# API key, see https://www.cloudflare.com/a/account/my-account,
# incorrect api-key results in E_UNAUTH error
CFKEY=fb6c39e44184770584120d0c99a3b34b8316f

# Username, eg: user@example.com
CFUSER=904347992@qq.com

# Zone name, eg: example.com
CFZONE_NAME=14401920.xyz

# Hostname to update, eg: homeserver.example.com
CFRECORD_NAME=hkt.14401920.xyz
...
RESPONSE=$(curl -s -X PUT "https://api.cloudflare.com/client/v4/zones/$CFZONE_ID/dns_records/$CFRECORD_ID" \
  ...
  --data "{\"id\":\"$CFZONE_ID\",\"type\":\"$CFRECORD_TYPE\",\"name\":\"$CFRECORD_NAME\",\"content\":\"$WAN_IP\", \"ttl\":\"$CFTTL\",\"proxied\":$PROXY}")
